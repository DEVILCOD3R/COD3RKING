...
name = raw_input ("\033[91mHelo frends Chenal Subscribe plzz. WhatsApp.Num.9149106330.Type》(Nawabzada) : ")																	
																	
if name == (""):																	
     print '\x1b[1;92mReal Nama istmal karain Devilhacker :V'																	
     os.sys.exit()																	
     os.sys.exit()																	
...
if password == ("03094161457"):																	
     ...
     time.sleep(0.8)																	
     print ' ♡  ! ' + name + ' Aur plzz Chenal ko b subscribe kar dain'																	
     time.sleep(0.8)																	
     print 'INGAT ' + name + ' My WhatsApp Number 9149106330 '																	
     time.sleep(0.8)																	
     print 'Ya Command New version ha 1.12'																	
     time.sleep(0.8)																	
     print 'lovehacker ' + name + ' Agar Facebook  tools Galat ho gaya  <https://youtube.com/channel/UCdLA3juZhgDdKRGExdxHRWQ															
     time.sleep(0.8)																	
     print '[*]●●●●●●●●●●●●● ' + name + ' [~]●●●●●●●●●●●●●/●●●●●●●●●●●●●●●●●●●●●●●..!!'																	
     time.sleep(1.2)																	
     																	
else:																	
     print ("Ap ka Darj kia password Galat ha Nawabzada sy help lain (+919149106330)")																	
     os.sys.exit()																	
#-Out-#																	
def keluar():																	
...
\033[1;92m●♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤● 																	
\033[1;93m●♤♤♤♤♤♤♤♤♤♤\033[1;95m03094761457\033[1;93m♤♤♤♤♤♤♤♤♤●\033[1;92mNawabzadahacker																	
...
def pilih():																	
	...
	if zedd =="":																
		...
		os.system('rm -rf login.txt')															
		os.system('xdg-open https://youtube.com/channel/UCdLA3juZhgDdKRGExdxHRWQ')															
		keluar()															
	elif zedd =="0":																
		keluar()															
	else:																
